...
;*****************************************************************************
;
; Modified for 8051 kit by W.Sirichote, October 2016 
;
;*****************************************************************************
...
B9600	EQU	0DCH		;Timervalue for 9600 baud
	;
	;
...
ROMADR	EQU	5000H		;LOCATION OF ROM
...
NCRST:	MOV	SCON,#5AH	;INITIALIZE SFR'S
;
;*****************************************************************************
...
BG16:
	mov dptr,#8202h
	clr a
	movx @dptr,a          ; turn off segment LED

	mov dptr,#8100h     
	movx @dptr,a          ; turn off GPIO1 LED

	mov dptr,#8201h
	cpl a
	movx @dptr,a	      ;	turn off digit 
...
ZRO:	NOP
	...
	NOP
	MOV	TEMP5,#1	;DELAY 30uS AT 12 MHZ
	DJNZ	TEMP5,$
...
;****** Boehling 3 ***********************************************************
;
CERASE: mov	R7,#30H 		;Erase 12K byte W.sirichote from 5000h to 7fffh
	mov	R6,#00H
